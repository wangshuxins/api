        ...
        <div class="login">
            <div class="row">
                <form class="col s12" method="post" action="http://www.blog.com/log">
                    ...
                    <a style="float:right" href="https://github.com/login/oauth/authorize?client_id=d2aa5c8ab674887a35f4&redirect_uri=http://1911wsx.comcto.com/oauth/github"><h6>Github授权</h6></a>
